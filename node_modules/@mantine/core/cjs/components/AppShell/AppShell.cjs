...
const AppShell = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(AppShell_context.AppShellProvider, { value: { getStyles, withBorder, zIndex, disabled, offsetScrollbars } }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root"), mod: { resizing, layout, disabled }, ...others }));
});
