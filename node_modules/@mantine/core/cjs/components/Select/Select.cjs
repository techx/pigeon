...
const Select = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Combobox.Combobox.Target, { targetType: searchable ? "input" : "button" }, /* @__PURE__ */ React.createElement(
      InputBase.InputBase,
      {
        id: _id,
        ref,
        rightSection: rightSection || clearButton || /* @__PURE__ */ React.createElement(Combobox.Combobox.Chevron, { size, error, unstyled }),
