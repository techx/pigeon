...
const NavLink = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    leftSection && /* @__PURE__ */ React.createElement(Box.Box, { component: "span", ...getStyles("section"), mod: { position: "left" } }, leftSection),
    /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("body"), mod: { "no-wrap": noWrap } }, /* @__PURE__ */ React.createElement(Box.Box, { component: "span", ...getStyles("label") }, label), /* @__PURE__ */ React.createElement(Box.Box, { component: "span", mod: { active }, ...getStyles("description") }, description)),
    (withChildren || rightSection) && /* @__PURE__ */ React.createElement(
      ...
      withChildren ? rightSection || /* @__PURE__ */ React.createElement(AccordionChevron.AccordionChevron, { ...getStyles("chevron") }) : rightSection
    )
  ), /* @__PURE__ */ React.createElement(Collapse.Collapse, { in: _opened }, /* @__PURE__ */ React.createElement("div", { ...getStyles("children") }, children)));
});
