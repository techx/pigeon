...
const RangeSlider = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Slider_context.SliderProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(SliderRoot.SliderRoot, { ...others, size, ref, disabled }, /* @__PURE__ */ React.createElement(
    Track.Track,
    {
      offset: positions[0],
