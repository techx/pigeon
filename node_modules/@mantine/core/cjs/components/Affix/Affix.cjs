...
const Affix = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root"), ...others }));
});
