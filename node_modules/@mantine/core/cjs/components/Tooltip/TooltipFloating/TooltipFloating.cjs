...
const TooltipFloating = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal }, /* @__PURE__ */ React.createElement(
    Box.Box,
    {
      ...others,
      ...getStyles("tooltip", {
