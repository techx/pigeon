...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { bulletSize, lineWidth, radius, color, autoContrast }) => ({
    root: {
      ...
      "--tl-icon-color": autoContrast ? getContrastColor.getContrastColor({ color, theme }) : void 0
    }
  })
);
const Timeline = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Timeline_context.TimelineProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("root"), mod: { align }, ref, ...others }, items));
});
