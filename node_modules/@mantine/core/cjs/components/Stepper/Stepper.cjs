...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { color, iconSize, size, contentPadding, radius, autoContrast }) => ({
    root: {
      ...
      "--stepper-icon-color": autoContrast ? getContrastColor.getContrastColor({ color, theme }) : void 0,
...
const Stepper = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Stepper_context.StepperProvider, { value: { getStyles, orientation, iconPosition } }, /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("root"), ref, size, ...others }, /* @__PURE__ */ React.createElement(
    Box.Box,
    {
      ...getStyles("steps"),
      mod: {
