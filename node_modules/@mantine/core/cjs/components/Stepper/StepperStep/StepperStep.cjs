...
const StepperStep = factory.factory((props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    withIcon && /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepWrapper", stylesApi) }, /* @__PURE__ */ React.createElement("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes }, /* @__PURE__ */ React.createElement(Transition.Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200 }, (transitionStyles) => /* @__PURE__ */ React.createElement(
      "span",
      {
      ...
      ) : getStepFragment(completedIcon, step) || /* @__PURE__ */ React.createElement(CheckIcon.CheckIcon, { size: "60%" })
