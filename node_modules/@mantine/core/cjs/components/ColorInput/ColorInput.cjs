...
const ColorInput = factory.factory((_props, ref) => {
  ...
  const eyeDropper = /* @__PURE__ */ React.createElement(
    ...
    eyeDropperIcon || /* @__PURE__ */ React.createElement(EyeDropperIcon.EyeDropperIcon, { ...getStyles("eyeDropperIcon") })
  );
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(Popover.Popover.Target, null, /* @__PURE__ */ React.createElement(
        Input.Input,
        {
          autoComplete: "off",
          ...others,
