...
const Card = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Card_context.CardProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(Paper.Paper, { ref, unstyled, ...getStyles("root"), ...others }, content));
});
