...
function HoverCard(props) {
  ...
  return /* @__PURE__ */ React.createElement(HoverCard_context.HoverCardContextProvider, { value: { openDropdown, closeDropdown } }, /* @__PURE__ */ React.createElement(Popover.Popover, { ...others, opened, __staticSelector: "HoverCard" }, children));
}
