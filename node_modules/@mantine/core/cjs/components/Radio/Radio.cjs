  ...
  (theme, { size, radius, color, iconColor, variant, autoContrast }) => {
    ...
    return {
      root: {
        ...
        "--radio-icon-color": iconColor ? getThemeColor.getThemeColor(iconColor, theme) : autoContrast ? getContrastColor.getContrastColor({ color, theme }) : void 0,
...
const Radio = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box.Box, { ...getStyles("inner"), mod: { "label-position": labelPosition } }, /* @__PURE__ */ React.createElement(
      Box.Box,
      {
