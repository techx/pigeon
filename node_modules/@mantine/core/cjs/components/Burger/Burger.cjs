...
const Burger = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(UnstyledButton.UnstyledButton, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ React.createElement(Box.Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }), children);
});
