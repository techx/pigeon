...
const varsResolver = createVarsResolver(
  (theme, { bulletSize, lineWidth, radius, color, autoContrast }) => ({
    root: {
      ...
      "--tl-icon-color": autoContrast ? getContrastColor({ color, theme }) : void 0
    }
  })
);
const Timeline = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(TimelineProvider, { value: { getStyles } }, /* @__PURE__ */ React.createElement(Box, { ...getStyles("root"), mod: { align }, ref, ...others }, items));
});
