...
const Grid = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Grid_context.GridProvider, { value: { getStyles, grow, columns } }, /* @__PURE__ */ React.createElement(GridVariables.GridVariables, { selector: `.${responsiveClassName}`, ...props }), /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others }, /* @__PURE__ */ React.createElement("div", { ...getStyles("inner") }, children)));
});
