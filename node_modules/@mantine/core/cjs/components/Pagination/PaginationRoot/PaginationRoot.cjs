...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { size, radius, color, autoContrast }) => ({
    root: {
      ...
      "--pagination-active-color": autoContrast ? getContrastColor.getContrastColor({ color, theme }) : void 0
    }
  })
);
const PaginationRoot = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box.Box, { ref, ...getStyles("root"), ...others })
  );
});
